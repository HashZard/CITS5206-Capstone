  ...
  return (
    <div className="max-w-4xl mx-auto">
      <header className="mb-8 text-center">
        ...
        <h1 className="text-3xl font-semibold text-foreground">Import</h1>
        <p className="text-muted-foreground">
          This is the Import page. Future upload functionality will be added here.
        </p>
      </header>

      <section className="rounded-lg border border-white/20 bg-white/10 backdrop-blur-sm p-6 text-foreground/90">
        <p>
